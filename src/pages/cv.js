  ...
  <div>
    <div className="mb-4 text-center">
      ...
      <div className="small text-muted">
        <FontAwesome icon="home" className="text-primary" /> San Jorge 60, Depto
        1503, Ñuñoa, Santiago, Chile -{' '}
        <FontAwesome icon="phone" className="text-primary" /> +56 9 5417 47 00 -{' '}
        <FontAwesome icon="envelope" className="text-primary" />{' '}
    ...
    <div className="mb-4 pt-4">
      ...
      <Experience
        ...
        institution={
          <span>
            <a href="https://ubiome.com" target="_blank">
              uBiome
            </a>{' '}
        ...
        description={
          <div>
            ...
            <ul className="pl-3">
              ...
              <li className="mb-1">
                <strong>
                  Design and development a new application from scratch for the
                  support of Daily Laboratory Operations
              ...
              <li className="mb-1">
                Support for multiple Laboratory data issues. The cause of these
                issues was found and fixed on the application described above.
              </li>
              <li className="mb-1">
              ...
              <li className="mb-1">
                Development of multiple microapplications, highlighting a system
                for assembling uBiome Kits, including batches generation,
                stickers, and the assembly process validation.
                <br />
                <span className="text-info">
      ...
      <Experience
        ...
        institution={
          <span>
            <a href="http://www.coddde.com" target="_blank">
              Coddde
            </a>{' '}
            - Santiago, Chile
          </span>
        ...
        description={
          <div>
            As a software house, contribution to multiple projects. The projects
            to which I contributed most (60%+ contribution) are:
            <ul className="pl-3">
              <li className="mt-1 mb-1">
              ...
              <li className="mb-1">
                ...
                <span className="text-info">
                  <strong>Stack:</strong> Ruby on Rails / Swift / React Native.
                </span>
              </li>
              <li className="mb-1">
      ...
      <Experience
        ...
        description={
          <div>
            Design of system, electronics and embedded computer of a system for
            active vibration control in astronomical instruments.
          </div>
        }
      />
    ...
    <div className="mb-4">
      ...
      <Experience
        ...
        institution="Pontifical Catholic University of Chile - Santiago, Chile"
        description={
          <div>Engineering Fundamentals with an ABET-based study program.</div>
        }
      />
    </div>
  </div>
